...
import br.com.estudo.springsecurity.exemplo.auth.ApplicationUserService;
import br.com.estudo.springsecurity.exemplo.jwt.JwtConfig;
import br.com.estudo.springsecurity.exemplo.jwt.JwtTokenVerifier;
import br.com.estudo.springsecurity.exemplo.jwt.JwtUsernameAndPasswordAuthenticationFilter;
...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable().sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and()
				...
				.authorizeRequests().antMatchers("/api/**").hasRole(STUDENT.name())
